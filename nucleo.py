...
def creaMatriz(dim):
    """Crea una matriz de orden dimxdim. Asigna a los 'bordes' el valor 31
       y al resto 0"""
...
def actualizaMatriz(matriz, jugador, direccion):
    ...
    """Dado una matriz, actualiza la posicion del jugador indicado en dicha
       matriz teniendo en cuenta la direccion pasada.
       NOTA: Si en direccion no se pasa un valor valido, se toma por defecto
       la 'derecha0' """
...
def resultado(matriz):
    """Devuelve una tupla. El primer valor indica el resultado de la matriz.
       ( 0 si el "juego" continua, 1 si gana el jugador uno, 2 si gana el
       jugador 2 y 3 si es empate).
...
def combate(jugador1, jugador2):
    """En este metodo se resolvera una "partida" entre jugador1 y jugador 2.
       Si gana el primero, se devolverá 1, si gana el segundo, 2 y si
       es empate, 3."""
...
def combatePasoAPaso(jugador1, jugador2):
    """Este metodo, en vez de devolver el resultado, devuelve una lista con
       cada una de las iteraciones de la matriz"""
...
def torneo(jugador1, oponentes, num):
    """oponentes es una lista de jugadores. Jugador 1 se enfrentará con cada
       uno tantos combates como diga num. El resultado será una lista donde
       cada posicion corresponde a un oponente. Dentro de dicha posicion, habra
...
def mostrarMatriz(matriz):
    """Muestra la matriz de forma simplificada, para
      'testeos' de la aplicacion"""
